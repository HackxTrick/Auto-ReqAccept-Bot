...
START_TEXT = "Hai {}\n\nI am Auto Request Accept Bot With Working For All Channels And Groups. Add Me In Your Channel Or Group To Use"
...
async def start_handler(c, m):
    ...
    button = [[        
        ...
        InlineKeyboardButton('OWNER⚡', url='https://t.me/ANIME_TIMETV'),
        InlineKeyboardButton('SUPPORT', url='https://t.me/INFINITE_EMPIRE')
